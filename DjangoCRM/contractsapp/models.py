...
class Contract(models.Model):
    ...
    document = models.FileField(null=True, upload_to='documents/', verbose_name="Файл с документом")
    date_signed = models.DateField(null=True, blank=True, verbose_name="Дата заключения")
    valid_until = models.DateField(null=True, blank=True, verbose_name="Период действия")
