    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.DecimalField(decimal_places=2, default=0, max_digits=8, verbose_name='Сумма')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productapp.product', verbose_name='Предоставляемая услуга')),
            ],
        ),
    ]
